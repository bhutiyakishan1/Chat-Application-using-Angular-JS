(function(){
    ...
    function mainControl(){
        ...
        function user(_username, _password, _name,_email, _phone, _location,_inbox,_sentmail) {
        ...
        function registerController($scope,$location) {
            ...
            $scope.tryRegister = function(){
                ...
                var check = true;
                $scope.alert = "";
                if($scope.username && $scope.password && $scope.name  && $scope.email && $scope.location && $scope.phone){
                    ...
                    if (check === true) {
                        var newuser = new user($scope.username, $scope.password, $scope.name, $scope.email, $scope.location, $scope.phone);
                        currentuser = newuser;
                        localStorage.setItem("userdata", JSON.stringify(currentuser));
                        users.push(newuser);
                        if (typeof(Storage) !== "undefined") localStorage.setItem("userdata", JSON.stringify(users));
                        $location.path('/login');
                    }
                }
            };
